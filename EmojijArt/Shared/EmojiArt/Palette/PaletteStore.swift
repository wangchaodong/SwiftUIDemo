...
//			for palettesAsPropertyArray in palettesAsPropertyList {
//				if palettesAsPropertyArray.count == 3,
//					let id = Int(palettesAsPropertyArray[2]),
//				   !palettes.contains(where: { $0.id == id}) {
//					let palette = Palette(name: palettesAsPropertyArray[0], emojis: palettesAsPropertyArray[1], id: id)
...
//		}
	...
	init(named name: String) {
		...
		if palettes.isEmpty {
			...
			print("palettes load from userDefaults")
		}
	}
