...
struct EmojiArtDocumentView: View {
	@ObservedObject var document: EmoijArtDocument
...
//		var id: BackgroundPickerType { self }
	...
	private func pasteBackground() {
		...
		if let imageData = Pasteboard.imageData {
			...
			alertToShow = IdentifiableAlert(
				...
				message: "there is no image in pasteboard"
			)
		}
	}
	...
	private func position(for emojij: EmojiArtModel.Emoji, in geometry: GeometryProxy) -> CGPoint {
		convertFromEmojiCoordinates((emojij.x, emojij.y), in: geometry)
	}
...
struct EmojiArtDocumentView_Previews: PreviewProvider {
    static var previews: some View {
        EmojiArtDocumentView(document: EmoijArtDocument())
    }
}
